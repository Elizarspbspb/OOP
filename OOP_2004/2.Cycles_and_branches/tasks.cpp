...
int main()
{
    ...
    do {
        ...
        cin >> num_1 >> mark >> num_2;
        switch(mark) {
            case '+':
                cout << num_1 << mark << num_2 << "=" << num_1 + num_2 << endl;
                break;
            case '-':
                cout << num_1 << mark << num_2 << "=" << num_1 - num_2 << endl;
                break;
            ...
            case '*':
                ...
                break;
            default:
                cout << num_1 << mark << num_2 << "Некорректная операция" << endl;
        }
    ...
    двух денежных сумм не имеет смысла, по-скольку квадратных денежных единиц не существует.
